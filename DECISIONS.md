...
- **Decision:**
  - **Memory Locks:** `mlockall`, `prctl(PR_SET_DUMPABLE, 0)`, `MADV_DONTDUMP`, `MADV_DONTFORK`, `MADV_UNMERGEABLE`, and the compiler flag `-Z zero-call-used-regs=all` will be enforced.
